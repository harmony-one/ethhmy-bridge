...
contract ERC20HmySecondaryManager {
    mapping(address => mapping(bytes32 => bool)) public usedEvents_;
    ...
    function mintToken(
        ...
        require(
            !usedEvents_[oneToken][receiptId],
            "HmyManager/The lock event cannot be reused"
        );
        usedEvents_[oneToken][receiptId] = true;
